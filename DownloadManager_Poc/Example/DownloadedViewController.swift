...
class DownloadedViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        do {
            let contentOfDir: [String] = try FileManager.default.contentsOfDirectory(atPath: Utility.baseFilePath as String)
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(downloadFinishedNotification(_:)), name: NSNotification.Name(rawValue: Utility.DownloadCompletedNotif as String), object: nil)
    }
...
extension DownloadedViewController {
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        ...
        let fileURL  : URL = URL(fileURLWithPath: (Utility.baseFilePath as NSString).appendingPathComponent(fileName as String))
        do {
